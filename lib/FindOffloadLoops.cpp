...
public:
  ...
  AccessNode(Loop *LoopPtr, LoadInst *LoadPtr, ScalarEvolution *SE,
    ...
    // ascend loops until first loop is found with no induction-dependency on
    // load
    TemporalReuse = false;
  ...
  LoadInst *getLoadPtr() { return LoadPtr; }
  Loop *getFirstNonInduction() { return FirstNonInductionLoop; }
  float getTripcountFactor() { return TripcountFactor; }
